...
Public Class User
    ...
    Private cnx As New MySqlConnection(My.Settings.ConectionString)
    Private PermisosOt As New Dictionary(Of String, Boolean)

    'Información del usuario
    Private UserName As String = ""
    Private UserNick As String = ""
    Private UserID As String = ""

    Private LogTemp As Boolean
    Private UserTempName As String
    Private UserTempId As String

    Sub New(uName As String, uNick As String, uId As String)
        UserName = uName
        UserNick = uNick
        UserID = uId
    ...
    'Funciones para obtener los valores del usuario -> nombre, nick, etc
    Public Function Get_Name() As String
        Return UserName
    End Function
    Public Function Get_Nick() As String
        Return UserNick
    End Function
    Public Function GetId() As String
        Return UserID
    End Function
    Public Function Get_Permisos() As Dictionary(Of String, Boolean)
        Return PermisosOt
    End Function
